...
export const COMPLAINT_ACTIONS = [
  ...
  'عطل داخلي', 'قاعدة محترقة', 'عداد محروق', 'محول / UDS', 'محطة طافية', 'عداد ذكي/حمل', 'عطل HT', 'عطل كيبل', 'خط هوائي', 'بلاط',
...
// How many units were replaced, asked alongside the size.
export const QUANTITY_OPTIONS = ['1', '2', '3'];
export const ACTIONS_WITH_QUANTITY = ['فيوز منزل', 'فيوز محطة / UDS', 'قاعدة محترقة'];

// Work that emergency crews stabilise but the operations team must finish.
// Closing a complaint with one of these hands it over automatically.
export const OPERATIONS_ACTIONS = [
  'عطل كيبل', 'بلاط', 'قاعدة محترقة', 'عطل HT', 'خط هوائي',
];
