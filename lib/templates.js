...
export const DOC_STYLES = `
  *{box-sizing:border-box;}
  ...
  .doc{background:#fff;color:#111;font-family:'Cairo',sans-serif;font-weight:700;padding:36px 50px;width:1300px;}
  .doc .doc-header{text-align:center;border-bottom:2px solid #333;padding:10px 0 30px;margin-bottom:20px;position:relative;min-height:150px;}
  .doc .doc-header .logo{position:absolute;top:0;right:0;height:120px;}
  .doc .doc-header .logo-left{position:absolute;top:0;left:0;height:120px;}
  ...
  .doc .doc-footer{margin-top:18px;padding-top:10px;border-top:1px solid #999;font-size:25px;color:#333;text-align:left;font-weight:600;}
  .doc table{width:100%;border-collapse:collapse;margin-bottom:10px;}
  .doc td, .doc th{border:1px solid #333;padding:28px 28px;font-size:30px;vertical-align:top;}
  ...
  .doc .box{border:1px solid #333;min-height:190px;padding:24px 26px;font-size:45px;white-space:pre-wrap;}
